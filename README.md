...
- `products.Product` with such attributes as [name, rate, price]
- `categories.Category` classes with the name attribute, for each store categories [bike, phone, milk] and products list
- `Store` - class that should handle categories list
- `RandomStorePopulator` - utility class that will populate out store/categories with fake data using `Faker` lib
